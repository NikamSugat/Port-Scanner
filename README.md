...
* Command: git clone https://github.com/NikamSugat/Port-Scanner.git

2. Changing Directory using Command:
* Command: cd simple-port-scanner

3. Run the port scanner script:

*Command: ./port_scanner.sh <target_host>
...
* Command: bash port_scanner.sh <target_host>
